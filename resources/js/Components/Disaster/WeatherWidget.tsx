...
const WeatherWidget: React.FC<WeatherWidgetProps> = ({ data }) => {
    ...
    return (
        <div className={cn(
            "p-6 rounded-2xl border border-teal-500/20 shadow-xl h-full",
            "bg-gradient-to-br from-teal-500/10 via-white/5 to-transparent backdrop-blur-sm"
        )}>
            <div className="flex justify-between items-start mb-6">
                <div>
                    <h3 className="text-xl font-bold text-teal-400 mb-1">Cuaca Saat Ini</h3>
            ...
            <div className="flex items-end gap-2 mb-8">
                <span className="text-5xl font-bold text-white">{Math.round(current.temperature_2m)}°</span>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-black/20 border border-white/5">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-semibold">{Math.round(current.apparent_temperature)}°C</p>
                    </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-black/20 border border-white/5">
