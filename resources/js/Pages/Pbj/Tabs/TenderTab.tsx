...
import { pbjTenderService } from '@/Services/pbjSplitService';
        ...
        <div className="flex flex-col h-full">
            <div className="overflow-x-auto min-h-[400px]">
                <Table striped className="min-w-full">
                    <Table.Head>
                        <Table.Tr className="bg-purple-50/50 dark:bg-purple-900/10">
                            <Table.Th className="text-[10px] font-black uppercase text-purple-400 tracking-widest py-5 px-6">ID Transaksi</Table.Th>
                            <Table.Th className="text-[10px] font-black uppercase text-purple-400 tracking-widest py-5 px-6">Detail Paket</Table.Th>
                            <Table.Th className="text-[10px] font-black uppercase text-purple-400 tracking-widest py-5 px-6">Satker & Penyedia</Table.Th>
                            <Table.Th className="text-[10px] font-black uppercase text-purple-400 tracking-widest py-5 px-6">Status</Table.Th>
                            <Table.Th className="text-[10px] font-black uppercase text-purple-400 tracking-widest py-5 px-6 text-right">Nilai</Table.Th>
                        </Table.Tr>
                    </Table.Head>
                    <Table.Body>
                        {loading ? (
                                ...
                                <Table.Tr key={item.order_id} className="hover:bg-slate-50/50 dark:hover:bg-neutral-900/30 transition-colors group cursor-pointer">
                                    <Table.Td className="py-5 px-6">
                                        <div className="flex flex-col gap-1.5">
                                            <span className="inline-flex w-fit items-center px-2 py-0.5 rounded-md text-[9px] font-black border uppercase tracking-tight bg-purple-100 text-purple-600 border-purple-200 dark:bg-purple-900/30 dark:text-purple-400 dark:border-purple-800">Tender</span>
                                    ...
                                    <Table.Td className="py-5 px-6 max-w-xs">
                                        <p className="text-sm font-semibold text-slate-800 dark:text-neutral-200 line-clamp-2 group-hover:text-purple-600 transition-colors">{item.nama_paket || item.nama_rup}</p>
