...
const IspuWidget: React.FC<IspuWidgetProps> = ({ data }) => {
    if (!data || !data.status_stasiun || data.status_stasiun.length === 0) {
        return (
            <div className="p-6 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 h-[480px] flex items-center justify-center text-neutral-500 italic shadow-xl">
    ...
    return (
        <div className="bg-white dark:bg-neutral-900 rounded-3xl p-6 shadow-2xl border border-neutral-200 dark:border-neutral-800 text-neutral-900 dark:text-neutral-100 font-sans">
            ...
            {/* Banner Pesan */}
            <div
                className="w-full p-6 rounded-xl mb-8 flex items-center justify-center text-center shadow-lg transform transition-transform hover:scale-[1.01]"
            ...
            <div>
                ...
                <div className="grid grid-cols-5 rounded-xl overflow-hidden shadow-lg border border-neutral-200 dark:border-neutral-800">
                    {[
