...
const WeatherWidget: React.FC<WeatherWidgetProps> = ({ data }) => {
    ...
    const getWeatherIcon = (code: number, className = "w-12 h-12") => {
        ...
        if (code >= 95) return <CloudLightning className={cn(className, "text-purple-400")} />;
    ...
    return (
        <div className={cn(
            ...
            <div className="flex justify-between items-start mb-8">
                <div>
                    <h3 className="text-sm font-bold text-teal-600 uppercase tracking-widest mb-1">Cuaca Saat Ini</h3>
                    <p className="text-2xl font-black text-neutral-800 dark:text-white uppercase tracking-tighter">Kota Padang</p>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="flex items-center gap-3 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-black text-neutral-800 dark:text-white">{Math.round(current.apparent_temperature)}°C</p>
                    </div>
                </div>
                <div className="flex items-center gap-3 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-black text-neutral-800 dark:text-white">{current.wind_speed_10m} km/h</p>
                    </div>
                </div>
            </div>
